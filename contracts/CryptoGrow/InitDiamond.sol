...
contract InitDiamond {
  ...
  function init(Args memory _args) external {
    ...
    s.cryptoGrow = _args.cryptoGrow;
    s.itemsBaseUri = "https://cryptogrow.com/metadata/items/";
    s.childChainManager = _args.childChainManager;

    s.domainSeparator = LibMeta.domainSeparator("cryptoGrowDiamond", "V1");
    ...
    s.hrvstContract = _args.hrvstContract;
